...
class PointLLMTrainer(Trainer):
    ...
    def create_optimizer_and_scheduler(self, num_training_steps: int):
        ...
        Overridden to support stagewise training with FSDP.
        """
        # Check if stagewise param groups are provided
        if hasattr(self, 'stagewise_param_groups') and self.stagewise_param_groups is not None:
            # Use stagewise param groups
            self.optimizer = AdamW(
                self.stagewise_param_groups,
